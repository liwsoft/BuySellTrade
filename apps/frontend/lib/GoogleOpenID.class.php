...
class GoogleOpenID
{
     ...
     * @var String
     */
    private $user, $email, $firstname, $lastname;
    ...
    public function getLoginUrl( $returnTo )
    {
        $params = array(
            ...
            'openid.sreg.optional' => 'email',*/
					  ...
					  'openid.sreg.required' => 'firstname,lastname,email',
						'openid.assoc_handle' => $this->getHandle()
        );
        ...
        if ( $params['openid_assoc_handle'] == $this->getHandle() )
        {
            ...
            if( $params['openid_sig'] == $signature )
            {
                ...
                $this->email = $params['openid_ext1_value_email'];
								$this->firstname = $params['openid_ext1_value_firstname'];
								$this->lastname = $params['openid_ext1_value_lastname'];
